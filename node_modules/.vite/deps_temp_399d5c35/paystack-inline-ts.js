...
// node_modules/paystack-inline-ts/dist/index.js
var PaystackPop = (
  /** @class */
  function() {
    function PaystackPop2() {
      var popup = new Mn();
      this.pop = popup;
    }
    PaystackPop2.prototype.isLoaded = function() {
      return this.pop.isLoaded();
    };
    PaystackPop2.prototype.newTransaction = function(options) {
      return this.pop.newTransaction(options);
    };
    PaystackPop2.prototype.resumeTransaction = function(options) {
      return this.pop.newTransaction(options);
    };
    PaystackPop2.prototype.cancelTransaction = function(idOrTransaction) {
      return this.pop.cancelTransaction(idOrTransaction);
    };
    PaystackPop2.prototype.preloadTransaction = function(options) {
      return this.pop.preloadTransaction(options);
    };
    PaystackPop2.prototype.checkout = function(options) {
      return this.pop.checkout(options);
    };
    PaystackPop2.prototype.paymentRequest = function(options) {
      return this.pop.paymentRequest(options);
    };
    return PaystackPop2;
  }()
);
var dist_default = PaystackPop;
export {
  dist_default as default
};
//# sourceMappingURL=paystack-inline-ts.js.map
